...
public class TinOreBlockBlock extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:tin_ore_block")
	public static final Block block = null;
	public TinOreBlockBlock(SlothcraftModElements instance) {
		super(instance, 546);
	}
