...
public class PlatinumOreBlockBlock extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:platinum_ore_block")
	public static final Block block = null;

	public PlatinumOreBlockBlock(SlothcraftModElements instance) {
		super(instance, 451);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("platinum_ore_block");
		}
