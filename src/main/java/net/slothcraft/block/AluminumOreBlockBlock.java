...
public class AluminumOreBlockBlock extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:aluminum_ore_block")
	public static final Block block = null;

	public AluminumOreBlockBlock(SlothcraftModElements instance) {
		super(instance, 210);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aluminum_ore_block");
		}
