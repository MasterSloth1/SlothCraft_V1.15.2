...
public class SilverOreBlockBlock extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:silver_ore_block")
	public static final Block block = null;
	public SilverOreBlockBlock(SlothcraftModElements instance) {
		super(instance, 499);
	}
