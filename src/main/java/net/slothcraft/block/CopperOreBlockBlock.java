...
public class CopperOreBlockBlock extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:copper_ore_block")
	public static final Block block = null;

	public CopperOreBlockBlock(SlothcraftModElements instance) {
		super(instance, 283);
	}
