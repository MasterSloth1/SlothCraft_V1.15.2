...
public class NickelOreBlockBlock extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:nickel_ore_block")
	public static final Block block = null;

	public NickelOreBlockBlock(SlothcraftModElements instance) {
		super(instance, 403);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("nickel_ore_block");
		}
