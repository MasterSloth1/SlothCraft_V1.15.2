...
public class LeadOreBlockBlock extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:lead_ore_block")
	public static final Block block = null;
	public LeadOreBlockBlock(SlothcraftModElements instance) {
		super(instance, 355);
	}
