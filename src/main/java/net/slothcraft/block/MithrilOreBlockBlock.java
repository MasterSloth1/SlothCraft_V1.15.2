...
public class MithrilOreBlockBlock extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:mithril_ore_block")
	public static final Block block = null;

	public MithrilOreBlockBlock(SlothcraftModElements instance) {
		super(instance, 379);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mithril_ore_block");
		}
