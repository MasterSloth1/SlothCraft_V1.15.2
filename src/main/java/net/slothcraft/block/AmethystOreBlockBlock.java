...
public class AmethystOreBlockBlock extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:amethyst_ore_block")
	public static final Block block = null;

	public AmethystOreBlockBlock(SlothcraftModElements instance) {
		super(instance, 234);
	}
