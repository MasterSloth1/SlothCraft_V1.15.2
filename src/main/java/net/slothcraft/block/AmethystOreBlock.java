...
public class AmethystOreBlock extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:amethyst_ore")
	public static final Block block = null;
	public AmethystOreBlock(SlothcraftModElements instance) {
		super(instance, 233);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("slothcraft:amethyst_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("slothcraft:amethyst_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
