...
public class JadeOreBlockBlock extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:jade_ore_block")
	public static final Block block = null;
	public JadeOreBlockBlock(SlothcraftModElements instance) {
		super(instance, 331);
	}
