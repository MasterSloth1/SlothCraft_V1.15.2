...
public class RubyOreBlockBlock extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:ruby_ore_block")
	public static final Block block = null;

	public RubyOreBlockBlock(SlothcraftModElements instance) {
		super(instance, 475);
	}
