...
public class IridiumOreBlock extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:iridium_ore")
	public static final Block block = null;

	public IridiumOreBlock(SlothcraftModElements instance) {
		super(instance, 306);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("slothcraft:iridium_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("slothcraft:iridium_ore"), configuredFeature);
		}
	}
