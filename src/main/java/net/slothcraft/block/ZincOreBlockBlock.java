...
public class ZincOreBlockBlock extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:zinc_ore_block")
	public static final Block block = null;

	public ZincOreBlockBlock(SlothcraftModElements instance) {
		super(instance, 618);
	}
