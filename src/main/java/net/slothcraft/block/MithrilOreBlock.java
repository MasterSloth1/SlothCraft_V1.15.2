...
public class MithrilOreBlock extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:mithril_ore")
	public static final Block block = null;

	public MithrilOreBlock(SlothcraftModElements instance) {
		super(instance, 378);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("slothcraft:mithril_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("slothcraft:mithril_ore"), configuredFeature);
		}
	}
