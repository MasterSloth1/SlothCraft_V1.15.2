...
public class ZincOreFeature extends OreFeature {
	public static final ZincOreFeature FEATURE = (ZincOreFeature) new ZincOreFeature().setRegistryName("slothcraft:zinc_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(ZincOreFeatureRuleTest.INSTANCE, SlothcraftModBlocks.ZINC_ORE.defaultBlockState(), 5))
	...
	private static class ZincOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<ZincOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("slothcraft:zinc_ore_match"), () -> codec);
