...
public class SilverOreFeature extends OreFeature {
	public static final SilverOreFeature FEATURE = (SilverOreFeature) new SilverOreFeature().setRegistryName("slothcraft:silver_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(SilverOreFeatureRuleTest.INSTANCE, SlothcraftModBlocks.SILVER_ORE.defaultBlockState(), 4))
	...
	private static class SilverOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<SilverOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("slothcraft:silver_ore_match"), () -> codec);
