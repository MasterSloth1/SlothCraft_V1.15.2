...
public class PlatinumOreFeature extends OreFeature {
	public static final PlatinumOreFeature FEATURE = (PlatinumOreFeature) new PlatinumOreFeature().setRegistryName("slothcraft:platinum_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(PlatinumOreFeatureRuleTest.INSTANCE, SlothcraftModBlocks.PLATINUM_ORE.defaultBlockState(), 3))
	...
	private static class PlatinumOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<PlatinumOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("slothcraft:platinum_ore_match"), () -> codec);
