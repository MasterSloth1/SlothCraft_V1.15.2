...
public class LeadOreFeature extends OreFeature {
	public static final LeadOreFeature FEATURE = (LeadOreFeature) new LeadOreFeature().setRegistryName("slothcraft:lead_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(LeadOreFeatureRuleTest.INSTANCE, SlothcraftModBlocks.LEAD_ORE.defaultBlockState(), 4))
	...
	private static class LeadOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<LeadOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("slothcraft:lead_ore_match"), () -> codec);
