...
public class IridiumOreFeature extends OreFeature {
	public static final IridiumOreFeature FEATURE = (IridiumOreFeature) new IridiumOreFeature().setRegistryName("slothcraft:iridium_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(IridiumOreFeatureRuleTest.INSTANCE, SlothcraftModBlocks.IRIDIUM_ORE.defaultBlockState(), 3))
			.range(new RangeDecoratorConfiguration(UniformHeight.of(VerticalAnchor.absolute(1), VerticalAnchor.absolute(20)))).squared().count(5);
	...
	private static class IridiumOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<IridiumOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("slothcraft:iridium_ore_match"), () -> codec);
