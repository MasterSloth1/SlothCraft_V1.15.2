...
public class TitaniumOreFeature extends OreFeature {
	public static final TitaniumOreFeature FEATURE = (TitaniumOreFeature) new TitaniumOreFeature().setRegistryName("slothcraft:titanium_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(TitaniumOreFeatureRuleTest.INSTANCE, SlothcraftModBlocks.TITANIUM_ORE.defaultBlockState(), 3))
	...
	private static class TitaniumOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<TitaniumOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("slothcraft:titanium_ore_match"), () -> codec);
