...
public class SaltFoodItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:salt_food")
	public static final Item block = null;
	public SaltFoodItem(SlothcraftModElements instance) {
		super(instance, 77);
	}
