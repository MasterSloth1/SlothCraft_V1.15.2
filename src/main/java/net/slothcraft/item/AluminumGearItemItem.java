...
public class AluminumGearItemItem extends Item {
	public AluminumGearItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("add 4 Aluminum ingots + 1 stone gear to the Gear's Maker"));
	}
}
