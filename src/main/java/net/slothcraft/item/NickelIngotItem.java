...
public class NickelIngotItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:nickel_ingot")
	public static final Item block = null;
	public NickelIngotItem(SlothcraftModElements instance) {
		super(instance, 404);
	}
