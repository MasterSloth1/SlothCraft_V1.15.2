...
public class CopperIngotItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:copper_ingot")
	public static final Item block = null;

	public CopperIngotItem(SlothcraftModElements instance) {
		super(instance, 284);
	}
