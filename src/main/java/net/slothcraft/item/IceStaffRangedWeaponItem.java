...
public class IceStaffRangedWeaponItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:ice_staff_ranged_weapon")
	public static final Item block = null;
	@ObjectHolder("slothcraft:entitybulletice_staff_ranged_weapon")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("ice_staff_ranged_weapon");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(Blocks.BLUE_ICE, (int) (1));
		}
