...
public class LeadIngotItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:lead_ingot")
	public static final Item block = null;
	public LeadIngotItem(SlothcraftModElements instance) {
		super(instance, 356);
	}
