...
public class TitaniumIngotItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:titanium_ingot")
	public static final Item block = null;

	public TitaniumIngotItem(SlothcraftModElements instance) {
		super(instance, 571);
	}
