...
public class IridiumArmorItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:iridium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("slothcraft:iridium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("slothcraft:iridium_armor_leggings")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD,
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "slothcraft:textures/models/armor/iridium_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("iridium_armor_helmet"));
		...
		}.setRegistryName("iridium_armor_chestplate"));
		...
		}.setRegistryName("iridium_armor_leggings"));
