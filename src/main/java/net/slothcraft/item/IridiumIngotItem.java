...
public class IridiumIngotItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:iridium_ingot")
	public static final Item block = null;
	public IridiumIngotItem(SlothcraftModElements instance) {
		super(instance, 308);
	}
