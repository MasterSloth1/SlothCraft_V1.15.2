...
public class MithrilIngotItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:mithril_ingot")
	public static final Item block = null;
	public MithrilIngotItem(SlothcraftModElements instance) {
		super(instance, 380);
	}
