...
public class UraniumGearItemItem extends Item {
	public UraniumGearItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("add 4 Uranium ingots + 1 stone gear to the Gear's Maker"));
	}
}
