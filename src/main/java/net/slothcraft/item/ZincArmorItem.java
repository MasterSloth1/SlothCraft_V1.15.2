...
public class ZincArmorItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:zinc_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("slothcraft:zinc_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("slothcraft:zinc_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("slothcraft:zinc_armor_boots")
	public static final Item boots = null;

	public ZincArmorItem(SlothcraftModElements instance) {
		super(instance, 633);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD,
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "slothcraft:textures/models/armor/zinc_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
