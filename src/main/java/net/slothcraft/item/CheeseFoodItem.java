...
public class CheeseFoodItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:cheese_food")
	public static final Item block = null;
	public CheeseFoodItem(SlothcraftModElements instance) {
		super(instance, 72);
	}
