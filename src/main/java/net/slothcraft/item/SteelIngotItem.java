...
public class SteelIngotItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:steel_ingot")
	public static final Item block = null;
	public SteelIngotItem(SlothcraftModElements instance) {
		super(instance, 524);
	}
