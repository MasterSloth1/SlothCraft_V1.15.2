...
public class RubyArmorItem extends SlothcraftModElements.ModElement {
	@ObjectHolder("slothcraft:ruby_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("slothcraft:ruby_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("slothcraft:ruby_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("slothcraft:ruby_armor_boots")
