...
public class PlatinumGearItemItem extends Item {
	public PlatinumGearItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("add 4 Platinum ingots + 1 stone gear to the Gear's Maker"));
	}
}
