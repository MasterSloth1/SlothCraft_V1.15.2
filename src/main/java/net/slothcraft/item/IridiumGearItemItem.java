...
public class IridiumGearItemItem extends Item {
	public IridiumGearItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("add 4 Iridium ingots + 1 stone gear to the Gear's Maker"));
	}
}
